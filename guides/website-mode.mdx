...
- **Click any text** to edit it in place. Headlines, your story, quotes and FAQ answers take **bold** and _italic_; labels and button text stay plain.
...
<Card
  title="Edit the classic page instead"
  icon="calendar-check"
  href="/guides/classic-page"
>
