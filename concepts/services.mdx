...
<Note>
  Group bookings and personal invites are **Pro only**. See [Free vs Pro](#free-tier-vs-pro).
</Note>
...
<CardGroup cols={2}>
  <Card title="Free tier" icon="circle">
    - **1 service** on your profile
    - **1 synced calendar**
    - One-to-one bookings only
    - Tikk branding on your page
  </Card>

  <Card title="Pro at €12/mo" icon="star">
    - **Unlimited services**
    - **Unlimited synced calendars**
    - Group bookings and personal invites
    - 0% transaction fee on paid services
    - Custom branding
    - Manual approval mode
  </Card>
</CardGroup>

Upgrade at [app.tikk.chat/register](https://app.tikk.chat/register).

<Tip>
  Make your first service a **free discovery call**. A short intro filters out unqualified leads and gives new visitors a low-friction way to book.
</Tip>